...
pada syntax menggunakan pipe %>%
1. deklarasi data apa yang digunakan (who)
2. melakukan tidy-ing data who pada kolom new_sp_m014 hingga newrelf65 menjadi kolom case
3. melakukan seleksi kolom variabel country, year, serta case
4. mengelompokkan data berdasarkan negara, kemudian tahun
5. megnhitung jumlah kasus / kolom case 
6. melakukan un-grouping 
7. population memiliki kolom country year dan population 
8. left join memutuskan kolom yang sama antara population ke dalam who
9. melakukan filter pada kolom yang tidak nonavailable (!is.na)
10 Fungsi mutate untuk meambah kolom baru yang bernama proportion dengan rumus case diagi population dikali 100 (persen)
